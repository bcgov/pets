...
PETS - PDF Extended Template Service extension for Common Document Generation Service (API) for generating documents from templates, data documents, and assets
...
└── PETS/                 - PETS Helm Chart Repository
    └── templates/         - PETS Helm Chart Template manifests
examples/                  - Collection of scripts demonstrating PETS usage
